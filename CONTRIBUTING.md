# Contributing to Auto-iFlow

Thank you for your interest in contributing to Auto-iFlow! This document provides guidelines and instructions for contributing to the project.
...
Auto-iFlow is currently licensed under AGPL-3.0. The CLA ensures the project has proper licensing flexibility should we introduce additional licensing options (such as commercial/enterprise licenses) in the future.
...
git clone https://github.com/AndyMik90/Auto-iFlow.git
cd Auto-iFlow
...
If you want to run Auto-iFlow from source (for development or testing unreleased features), follow these steps:

### Step 1: Clone and Set Up

```bash
git clone https://github.com/AndyMik90/Auto-iFlow.git
cd Auto-iFlow/apps/backend
...
Auto-iFlow automatically downloads prebuilt binaries for Windows. If prebuilts aren't available for your Electron version yet, you'll need Visual Studio Build Tools:
...
> **Note:** For regular usage, we recommend downloading the pre-built releases from [GitHub Releases](https://github.com/AndyMik90/Auto-iFlow/releases). Running from source is primarily for contributors and those testing unreleased features.
...
Auto-iFlow consists of two main parts:
...
Thank you for contributing to Auto-iFlow!
