"""
Custom MCP Tools for Auto-iFlow Agents
======================================

This module provides custom MCP tools that agents can use for reliable
operations on auto-iflow data structures. These tools replace prompt-based
...
Usage:
    from auto_iflow_tools import create_auto_iflow_mcp_server, get_allowed_tools

    # Create the MCP server
    mcp_server = create_auto_iflow_mcp_server(spec_dir, project_dir)
    ...
    options = ClaudeAgentOptions(
        mcp_servers={"auto-iflow": mcp_server},
...
from .registry import create_auto_iflow_mcp_server, is_tools_available

__all__ = [
    # Main API
    "create_auto_iflow_mcp_server",
    "get_allowed_tools",
    "is_tools_available",
    # Agent configuration registry
    "AGENT_CONFIGS",
    ...
    "ELECTRON_TOOLS",
    "PUPPETEER_TOOLS",
    # Auto-iFlow tool name constants
    "TOOL_UPDATE_SUBTASK_STATUS",
    "TOOL_GET_BUILD_PROGRESS",
    "TOOL_RECORD_DISCOVERY",
    "TOOL_RECORD_GOTCHA",
