...
Defines tool name constants and configuration for Auto-iFlow MCP tools.
...
- Auto-iFlow tools: Custom build management tools
"""
...
# =============================================================================
# Auto-iFlow MCP Tools (Custom build management)
# =============================================================================

# Auto-iFlow MCP tool names
AUTO_BUILD_MCP_CANONICAL = "auto-iflow"
AUTO_BUILD_MCP_SERVER = AUTO_BUILD_MCP_CANONICAL
AUTO_BUILD_MCP_ALIASES: dict[str, str] = {}

TOOL_UPDATE_SUBTASK_STATUS = "mcp__auto-iflow__update_subtask_status"
TOOL_GET_BUILD_PROGRESS = "mcp__auto-iflow__get_build_progress"
TOOL_RECORD_DISCOVERY = "mcp__auto-iflow__record_discovery"
TOOL_RECORD_GOTCHA = "mcp__auto-iflow__record_gotcha"
TOOL_GET_SESSION_CONTEXT = "mcp__auto-iflow__get_session_context"
TOOL_UPDATE_QA_STATUS = "mcp__auto-iflow__update_qa_status"
...
AGENT_CONFIGS = {
    ...
    "planner": {
        ...
        "mcp_servers": ["context7", "graphiti", AUTO_BUILD_MCP_SERVER],
    ...
    "qa_reviewer": {
        ...
        "tools": BASE_READ_TOOLS + BASE_WRITE_TOOLS + WEB_TOOLS,
        "mcp_servers": ["context7", "graphiti", AUTO_BUILD_MCP_SERVER, "browser"],
...
def get_agent_config(agent_type: str) -> dict:
    ...
    Returns:
        Configuration dict containing tools, mcp_servers, auto_iflow_tools, thinking_default
...
def _map_mcp_server_name(
    ...
    mappings = {
        ...
        "electron": "electron",
        "puppeteer": "puppeteer",
        "auto-iflow": AUTO_BUILD_MCP_SERVER,
    }
...
def get_required_mcp_servers(
    ...
    - Respects per-project MCP config overrides from .auto-iflow/.env
    ...
    Args:
        ...
        mcp_config: Per-project MCP server toggles from .auto-iflow/.env
    ...
    # Process removals (but never remove the auto-build MCP server)
    if remove_key in mcp_config:
        ...
        for server in removals:
            mapped = _map_mcp_server_name(server, custom_server_ids)
            if mapped and mapped != AUTO_BUILD_MCP_SERVER:
