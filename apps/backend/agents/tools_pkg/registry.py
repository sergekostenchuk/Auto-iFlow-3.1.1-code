...
Central registry for creating and managing Auto-iFlow MCP tools.
"""

from pathlib import Path

try:
    from iflow_agent_sdk import create_sdk_mcp_server
...
def create_auto_iflow_mcp_server(spec_dir: Path, project_dir: Path):
    """
    Create an MCP server with Auto-iFlow custom tools.
    ...
    return create_sdk_mcp_server(name="auto-iflow", version="1.0.0", tools=tools)
