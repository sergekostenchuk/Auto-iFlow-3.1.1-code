...
Usage:
    ...
    python apps/backend/analysis/analyzer.py --index

    # Analyze specific service
    python apps/backend/analysis/analyzer.py --service backend

    # Output to specific file
    python apps/backend/analysis/analyzer.py --index --output path/to/output.json
