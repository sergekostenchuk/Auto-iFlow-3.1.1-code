...
from init import init_auto_build_dir
...
class IdeationConfigManager:
    ...
    def __init__(
        ...
        Args:
            ...
            output_dir: Output directory for ideation files (defaults to data_dir/ideation)
            ...
            model: iFlow model to use (use "auto" to follow iFlow profile settings)
        ...
        self.thinking_level = self.generator.thinking_level
    ...
    def _setup_output_dir(self, output_dir: Path | None) -> Path:
        ...
        if output_dir:
            ...
            auto_build_dir, _ = init_auto_build_dir(self.project_dir)
            out_dir = auto_build_dir / "ideation"
