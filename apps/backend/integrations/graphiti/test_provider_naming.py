...
Shows how Auto-iFlow automatically generates provider-specific database names
...
def test_provider_naming():
    ...
    for provider, model, dim in providers:
        ...
        db_name = config.get_provider_specific_database_name("auto_iflow_memory")
        ...
        print(f"  Full Path: ~/.auto-iflow/graphs/{db_name}/")
        print()
