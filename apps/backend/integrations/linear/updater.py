...
from iflow_agent_sdk import ClaudeAgentOptions, ClaudeSDKClient
...
class LinearTaskState:
    """State of a Linear task for an Auto-iFlow spec."""
...
def _create_linear_client() -> ClaudeSDKClient:
    """
    Create a minimal client with only Linear MCP tools.
    ...
    if not has_iflow_auth():
        raise ValueError("iFlow authentication required")
