...
class FileEvolutionTracker:
    ...
    - File content snapshots in the data dir baselines/
    ...
    def __init__(
        ...
        Args:
            ...
            storage_dir: Directory for evolution data (default: data dir)
        ...
        storage_dir = storage_dir or resolve_auto_build_dir_for_write(self.project_dir)
