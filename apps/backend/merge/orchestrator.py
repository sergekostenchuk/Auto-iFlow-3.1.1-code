...
from .ai_resolver import AIResolver, create_iflow_resolver
...
class MergeOrchestrator:
    ...
    def __init__(
        ...
        Args:
            ...
            storage_dir: Directory for merge data (default: data dir)
        ...
        self.storage_dir = storage_dir or resolve_auto_build_dir_for_write(self.project_dir)
    ...
    def ai_resolver(self) -> AIResolver:
        ...
        if not self._ai_resolver_initialized:
            if self.enable_ai:
                self._ai_resolver = create_iflow_resolver()
            else:
