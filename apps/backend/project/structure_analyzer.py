...
# Keep in sync with security.constants (importing security.* here causes circular imports)
...
class StructureAnalyzer:
    ...
    CUSTOM_ALLOWLIST_FILENAMES = (ALLOWLIST_FILENAME,)
    ...
    def load_custom_allowlist(self) -> None:
        ...
        for filename in self.CUSTOM_ALLOWLIST_FILENAMES:
            content = self.parser.read_text(filename)
            if not content:
                continue
