...
- **If task_type != code**: produce a concise **analysis/plan/audit/content** spec.
  - Do NOT include coding steps, tests, or build commands.
  - Use `verification` as a manual checklist.
- Use `acceptance_map` and `output_files` to keep scope precise.
