...
async def run_qa_fixer_session(
    ...
    # spec_dir is typically: /project/.auto-iflow/specs/001-name/
    ...
    try:
        debug("qa_fixer", "Sending query to agent...")
        ...
        while True:
            try:
                ...
                message = (
                    f"No agent output for {timeout_display}s; aborting QA fixer session"
                )
                debug_error(
                    "qa_fixer",
