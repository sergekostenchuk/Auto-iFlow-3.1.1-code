...
Usage:
    ...
    python apps/backend/run.py --spec 001 --merge     # Add completed build to project
    python apps/backend/run.py --spec 001 --review    # See what was built
    python apps/backend/run.py --spec 001 --discard   # Delete build (requires confirmation)
