...
cache_dir = project_dir / ".auto-iflow" / "ai_cache"
...
### Custom Analysis with iFlow Client

```python
from ai_analyzer.claude_client import IFlowAnalysisClient

# Create client for custom queries
client = IFlowAnalysisClient(project_dir)
...
```python
from ai_analyzer import AIAnalyzerRunner
from ai_analyzer.claude_client import IFLOW_SDK_AVAILABLE
