...
A modular, well-structured package for AI-powered code analysis using the iFlow SDK.
...
├── claude_client.py      # iFlow SDK client wrapper
...
#### `claude_client.py`
- `IFlowAnalysisClient`: Wrapper for iFlow SDK
- Handles auth validation
- Creates iFlow client settings
...
#### `result_parser.py`
- `ResultParser`: Parses JSON from model responses
