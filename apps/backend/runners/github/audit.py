...
class AuditLogger:
    ...
    Usage:
        audit = AuditLogger(
            log_dir=resolve_auto_build_dir_for_write(project_dir) / "github" / "audit"
        )
    ...
    def __init__(
        ...
        Args:
            log_dir: Directory for audit logs (default: data dir / github / audit)
        ...
        """
        default_log_dir = resolve_auto_build_dir_for_write(Path.cwd()) / "github" / "audit"
