...
PR follow-up reviewer using iFlow SDK subagents for parallel specialist analysis.
...
from iflow_agent_sdk import AgentDefinition
...
class ParallelFollowupReviewer:
    ...
    def __init__(
        ...
        data_dir_name = resolve_auto_build_dir_for_write(project_dir).name
        worktree_dir = f"{data_dir_name}/github/pr/worktrees"
...
"""
    ...
    async def review(self, context: FollowupReviewContext) -> PRReviewResult:
        ...
        try:
            ...
            auto_build_path = resolve_auto_build_dir_for_write(self.project_dir).name
