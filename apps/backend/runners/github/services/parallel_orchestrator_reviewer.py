...
PR reviewer using iFlow SDK subagents for parallel specialist analysis.
...
class ParallelOrchestratorReviewer:
    ...
    def __init__(
        ...
        data_dir_name = resolve_auto_build_dir_for_write(self.project_dir).name
...
"""
    ...
    async def review(self, context: PRContext) -> PRReviewResult:
        ...
        try:
            ...
            # SDK handles parallel execution when the orchestrator invokes multiple Task tools
    ...
    def _generate_summary(
        ...
        lines.append("---")
        lines.append("_Generated by Auto iFlow Parallel Orchestrator (SDK Subagents)_")
