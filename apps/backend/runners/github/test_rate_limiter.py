...
class TestCostTracker:
    ...
    def test_calculate_cost_glm(self):
        """Calculate cost for glm-4.7."""
    ...
    def test_calculate_cost_kimi(self):
        """Calculate cost for kimi-k2-thinking."""
        cost = CostTracker.calculate_cost(
            input_tokens=1_000_000,
            output_tokens=1_000_000,
    ...
    def test_calculate_cost_qwen(self):
        """Calculate cost for qwen3-coder-plus."""
        cost = CostTracker.calculate_cost(
            input_tokens=1_000_000,
            output_tokens=1_000_000,
...
class TestIntegration:
    ...
    async def test_cost_tracking_multiple_models(self):
        ...
        # kimi-k2-thinking for complex analysis
        limiter.track_ai_cost(
            input_tokens=20_000,
