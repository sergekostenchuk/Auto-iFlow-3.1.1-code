...
Usage:
    ...
    python apps/backend/runners/ideation_runner.py --project /path/to/project --types low_hanging_fruit,high_value_features
    python apps/backend/runners/ideation_runner.py --project /path/to/project --refresh
"""
...
def main():
    ...
    parser.add_argument(
        "--output",
        type=Path,
        help="Output directory for ideation files (default: project/.auto-iflow/ideation)",
    )
    parser.add_argument(
        "--types",
        type=str,
    ...
    parser.add_argument(
        ...
        default="auto",
        help=(
            "Model to use (full model ID, or 'auto' to follow model routing settings)"
        ),
    )
    parser.add_argument(
        "--thinking-level",
        type=str,
        default="auto",
        choices=["auto", "none", "low", "medium", "high", "ultrathink"],
        help="Thinking level for extended reasoning (default: auto)",
    )
    parser.add_argument(
        "--refresh",
        action="store_true",
