...
Usage:
    ...
    python apps/backend/runners/roadmap_runner.py --project /path/to/project --refresh
    python apps/backend/runners/roadmap_runner.py --project /path/to/project --output roadmap.json
"""
...
def main():
    ...
    parser.add_argument(
        "--output",
        type=Path,
        help="Output directory for roadmap files (default: project/.auto-iflow/roadmap)",
    )
    parser.add_argument(
        "--model",
        type=str,
