...
Usage:
    ...
    python service_context.py --service backend --output backend/SERVICE_CONTEXT.md

    # Generate for all services (using project index)
    python service_context.py --all

    # Generate with custom project index
    python service_context.py --service frontend --index .auto-iflow/project_index.json
"""
...
class ServiceContextGenerator:
    ...
    def _load_project_index(self) -> dict:
        """Load project index from file (data directory)."""
