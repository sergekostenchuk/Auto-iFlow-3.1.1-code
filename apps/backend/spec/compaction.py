...
from phase_config import get_bootstrap_model
...
async def summarize_phase_output(
    ...
    Uses a lightweight iFlow model by default for summarization.
    ...
    Args:
        ...
        model: Model to use for summarization (defaults to bootstrap model)
...
"""
    ...
    try:
        async with client:
            ...
            response_text = ""
            async for msg in iter_agent_messages(client):
