...
Validates scope_contract.json structure:
- File exists and is valid JSON
- Contains required fields (intent, where, acceptance, test_plan, allowed_paths)
- Validates allowed/forbidden paths with guardrail rules
...
# Create validator
spec_dir = Path(".auto-iflow/specs/001-feature")
...
```bash
# Validate all checkpoints
python apps/backend/spec/validate_spec.py --spec-dir .auto-iflow/specs/001-feature/ --checkpoint all

# Validate specific checkpoint
python apps/backend/spec/validate_spec.py --spec-dir .auto-iflow/specs/001-feature/ --checkpoint context

# Auto-fix and validate
python apps/backend/spec/validate_spec.py --spec-dir .auto-iflow/specs/001-feature/ --auto-fix --checkpoint plan

# JSON output
python apps/backend/spec/validate_spec.py --spec-dir .auto-iflow/specs/001-feature/ --checkpoint all --json
```
