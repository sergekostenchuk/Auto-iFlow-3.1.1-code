...
class SpecValidator:
    ...
    def __init__(self, spec_dir: Path):
        ...
        self._scope_contract_validator = ScopeContractValidator(self.spec_dir)
    ...
    def validate_scope_contract(self) -> ValidationResult:
        """Validate scope_contract.json exists and has required structure.

        Returns:
            ValidationResult for scope contract checkpoint
        """
        return self._scope_contract_validator.validate()
