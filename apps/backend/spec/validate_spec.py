...
Usage:
    python apps/backend/spec/validate_spec.py --spec-dir .auto-iflow/specs/001-feature/ --checkpoint prereqs
    python apps/backend/spec/validate_spec.py --spec-dir .auto-iflow/specs/001-feature/ --checkpoint context
    python apps/backend/spec/validate_spec.py --spec-dir .auto-iflow/specs/001-feature/ --checkpoint spec
    python apps/backend/spec/validate_spec.py --spec-dir .auto-iflow/specs/001-feature/ --checkpoint plan
