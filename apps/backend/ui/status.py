...
class StatusManager:
    """Manages the .auto-iflow-status file for ccstatusline integration."""
    ...
    def __init__(self, project_dir: Path):
        ...
        self.primary_status_file = self.project_dir / ".auto-iflow-status"
        self.status_file = self.primary_status_file
