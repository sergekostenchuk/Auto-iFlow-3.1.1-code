...
export class AgentManager extends EventEmitter {
  ...
  /**
   * Configure paths for Python and auto-iflow source
   */
  ...
  async startSpecCreation(
    ...
    // Pre-flight auth check: verify iFlow authentication
    if (!hasIflowAuth()) {
      this.emit('error', taskId, 'iFlow authentication required. Configure an API key or Web login in Settings > Integrations.');
      return;
    }
