...
export class ChangelogService extends EventEmitter {
   ...
   * Checks DEBUG from auto-iflow/.env and DEBUG from process.env
   */
  ...
  /**
   * Debug logging - only logs when DEBUG=true in auto-iflow/.env or DEBUG is set
   */
  ...
  /**
   * Load environment variables from auto-iflow .env file
   */
