...
- Manages Python and auto-iflow source path configuration
- Detects auto-iflow installation automatically
- Loads environment variables from auto-iflow .env file
