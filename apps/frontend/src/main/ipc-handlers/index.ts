...
import { registerConsiliumHandlers } from './consilium-handlers';
...
export function setupIpcHandlers(
  ...
  // iFlow CLI handlers (status checking)
  ...
  // Consilium multi-agent orchestrator handlers
  registerConsiliumHandlers(getMainWindow);
