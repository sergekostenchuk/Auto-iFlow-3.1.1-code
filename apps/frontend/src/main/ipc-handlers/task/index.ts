...
import { registerTaskPlanImportHandlers } from './plan-import-handlers';
import { registerTaskPostCodeTestsHandlers } from './post-code-tests-handlers';
...
export function registerTaskHandlers(
  ...
  // Register task plan import handler
  registerTaskPlanImportHandlers(agentManager, getMainWindow);

  // Register post-code tests handlers (re-run/fix)
  registerTaskPostCodeTestsHandlers(pythonEnvManager);

  // Register intake handlers (strict task creation)
  registerIntakeHandlers(getMainWindow);
