 ...
 *
 * Handles loading and saving profiles.json from the auto-iflow directory.
...
const PROFILE_DIR_NAME = 'auto-iflow';

/**
 * Get the path to profiles.json in the auto-iflow directory
 */
export function getProfilesFilePath(): string {
  const userDataPath = app.getPath('userData');
  return path.join(userDataPath, PROFILE_DIR_NAME, 'profiles.json');
}
 ...
 * Creates the auto-iflow directory if it doesn't exist
