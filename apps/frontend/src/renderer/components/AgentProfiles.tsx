...
import { DEFAULT_AGENT_PROFILES, AVAILABLE_CODING_MODELS, THINKING_LEVELS } from '../../shared/constants';
...
export function AgentProfiles() {
  ...
  const getModelLabel = (modelValue: string): string => {
    const model = AVAILABLE_CODING_MODELS.find((m) => m.value === modelValue);
        ...
        <div className="max-w-2xl mx-auto space-y-4">
          ...
          <div className="rounded-lg bg-muted/50 p-4 mb-6">
            <p className="text-sm text-muted-foreground">
              Agent profiles provide preset configurations for iFlow models and thinking levels.
