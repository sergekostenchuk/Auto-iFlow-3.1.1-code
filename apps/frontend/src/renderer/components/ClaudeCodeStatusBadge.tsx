...
export function ClaudeCodeStatusBadge({ className }: ClaudeCodeStatusBadgeProps) {
  ...
  const getTooltipText = () => {
    switch (status) {
      case 'loading':
        return t('navigation:claudeCode.checking', 'Checking iFlow CLI...');
      case 'installed':
        return t('navigation:claudeCode.upToDate', 'iFlow CLI is up to date');
      case 'outdated':
        return t('navigation:claudeCode.updateAvailable', 'iFlow CLI update available');
      case 'not-found':
        return t('navigation:claudeCode.notInstalled', 'iFlow CLI not installed');
      case 'error':
        return t('navigation:claudeCode.error', 'Error checking iFlow CLI');
    }
  };
    ...
    <Popover open={isOpen} onOpenChange={setIsOpen}>
        ...
        <TooltipTrigger asChild>
          <PopoverTrigger asChild>
            ...
            >
              ...
              <span className="truncate">iFlow CLI</span>
              {status === 'outdated' && (
      ...
      <PopoverContent side="right" align="end" className="w-72">
        <div className="space-y-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              <h4 className="text-sm font-medium">iFlow CLI</h4>
          ...
          <Button
            ...
            aria-label={t('navigation:claudeCode.learnMoreAriaLabel', 'Learn more about iFlow CLI (opens in new window)')}
          >
            {t('navigation:claudeCode.learnMore', 'Learn more about iFlow CLI')}
      ...
      <AlertDialog open={showUpdateWarning} onOpenChange={setShowUpdateWarning}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>
              {t('navigation:claudeCode.updateWarningTitle', 'Update iFlow CLI?')}
            </AlertDialogTitle>
            <AlertDialogDescription>
              {t('navigation:claudeCode.updateWarningDescription', 'Updating will close all running iFlow CLI sessions. Any unsaved work in those sessions may be lost. Make sure to save your work before proceeding.')}
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel>
