...
function getSourceName(source: SDKRateLimitInfo['source']): string {
  switch (source) {
    ...
    default: return 'iFlow Operation';
  }
}
        ...
        <div className="py-4 space-y-4">
              ...
              <>
                ...
                <p>
                  ...
                  {hasMultipleProfiles
                    ...
                    : ' Add another iFlow account to continue working.'}
                </p>
              </>
            )}
          </div>
          ...
          <div className="rounded-lg border border-accent/50 bg-accent/10 p-4">
            ...
            {hasMultipleProfiles ? (
              <>
                <p className="text-sm text-muted-foreground mb-3">
                  {suggestedProfile ? (
                    ...
                    'Switch to another iFlow account and retry the operation:'
                  )}
                </p>
              ...
              <p className="text-sm text-muted-foreground mb-3">
                Add another iFlow subscription to automatically switch when you hit rate limits.
              </p>
            )}
            ...
            <div className={hasMultipleProfiles ? "mt-4 pt-3 border-t border-border/50" : ""}>
              <p className="text-xs text-muted-foreground mb-2">
                {hasMultipleProfiles ? 'Add another account:' : 'Connect an iFlow account:'}
              </p>
              <div className="flex items-center gap-2">
                <Input
              ...
              <p className="text-xs text-muted-foreground mt-2">
                This will open iFlow login to authenticate the new account.
              </p>
            </div>
          </div>
          ...
          <div className="rounded-lg border border-primary/30 bg-primary/5 p-4">
            ...
            <p className="text-sm text-muted-foreground mb-3">
              Upgrade your iFlow subscription for higher usage limits.
            </p>
            <Button
              variant="outline"
              size="sm"
          ...
          <div className="text-xs text-muted-foreground bg-muted/30 rounded-lg p-3">
            ...
            <p>
              The {sourceName.toLowerCase()} operation was stopped because your iFlow account
              ...
              {hasMultipleProfiles
                ...
                : ' Add another iFlow account above to continue working, or wait for the limit to reset.'}
            </p>
          </div>
        </div>
