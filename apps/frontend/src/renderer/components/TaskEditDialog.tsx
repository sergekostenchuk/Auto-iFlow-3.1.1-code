 ...
 * - Editable review settings (requireReviewBeforeCoding, requireReviewBeforeMerge)
...
export function TaskEditDialog({ task, open, onOpenChange, onSaved }: TaskEditDialogProps) {
  ...
  const [requireReviewBeforeMerge, setRequireReviewBeforeMerge] = useState(
    task.metadata?.requireReviewBeforeMerge ?? true
  );
  ...
  useEffect(() => {
    if (open) {
      ...
      setRequireReviewBeforeMerge(task.metadata?.requireReviewBeforeMerge ?? true);
      setError(null);
  ...
  const handleSave = async () => {
    ...
    const hasChanges =
      ...
      requireReviewBeforeMerge !== (task.metadata?.requireReviewBeforeMerge ?? true) ||
    ...
    metadataUpdates.requireReviewBeforeMerge = requireReviewBeforeMerge;
        ...
        <div className="space-y-5 py-4">
          ...
          <div className="space-y-4 p-4 rounded-lg border border-border bg-muted/30">
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 space-y-1">
                <Label
                  htmlFor="edit-require-merge-review"
                  className="text-sm font-medium text-foreground cursor-pointer"
                >
