...
export function ClaudeCodeStep({ onNext, onBack, onSkip }: ClaudeCodeStepProps) {
  ...
  const getStatusText = () => {
    switch (status) {
      case 'loading':
        return t('claudeCode.detecting', 'Checking iFlow CLI installation...');
      case 'installed':
      ...
      <div className="w-full max-w-2xl">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-foreground tracking-tight">
            {t('claudeCode.title', 'iFlow CLI')}
          </h1>
          <p className="mt-2 text-muted-foreground">
            {t('claudeCode.description', 'Install or update the iFlow CLI to enable AI-powered features')}
          </p>
        </div>
        ...
        <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 space-y-3">
                  <p className="text-sm font-medium text-foreground">
                    {t('claudeCode.info.title', 'What is iFlow CLI?')}
                  </p>
                  <p className="text-sm text-muted-foreground">
                    {t('claudeCode.info.description', "The iFlow CLI powers Auto-iFlow's AI features. It provides secure authentication and direct access to iFlow models.")}
                  </p>
                </div>
              </div>
            </CardContent>
              ...
              >
                {isInstalling ? (
                  ...
                  <>
                    ...
                    {status === 'outdated'
                      ? t('claudeCode.install.updating', 'Update iFlow CLI')
                      : t('claudeCode.install.button', 'Install iFlow CLI')
                    }
                  </>
                )}
              </Button>
          ...
          <div className="flex justify-center">
            ...
            >
              {t('claudeCode.learnMore', 'Learn more about iFlow CLI')}
