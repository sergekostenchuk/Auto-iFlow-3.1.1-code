              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 space-y-3">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Auto-iFlow requires iFlow authentication for AI-powered features like
                    Roadmap generation, Task automation, and Ideation.
                  </p>
                  <p className="text-sm text-muted-foreground">
                    This will open a browser window to authenticate with your iFlow account.
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div className="text-xs text-muted-foreground space-y-1">
                    ...
                    <ol className="list-decimal list-inside space-y-1 ml-2">
                      <li>A terminal opened and ran <code className="px-1 bg-muted rounded">iflow -i "/auth"</code></li>
                      <li>Your browser should open to authenticate with iFlow</li>
                      <li>Complete the OAuth flow in your browser</li>
                      <li>Credentials are stored in <code className="px-1 bg-muted rounded">~/.iflow</code></li>
                      <li>Auto-iFlow will automatically detect and save it</li>
                    </ol>
                  </div>
                </div>
              </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-success/80 mt-1">
                  {email ? `Connected as ${email}` : 'Your iFlow credentials have been saved'}
                </p>
                <div className="flex items-center gap-2 mt-3 text-xs text-success/70">
                  <Sparkles className="h-3 w-3" />
                  <span>You can now use all Auto-iFlow AI features</span>
                </div>
              </div>
            </div>
          </CardContent>
