          ...
          <div className="space-y-6">
            <div className="space-y-3">
              ...
              >
                ...
                <SelectContent>
                  <SelectItem value="auto-iflow">{t('general.agentFrameworkAutoClaude')}</SelectItem>
                </SelectContent>
              </Select>
            </div>
            <div className="space-y-3">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between max-w-md">
                <div className="space-y-1">
                  <Label htmlFor="intakeV2Enabled" className="text-sm font-medium text-foreground">
                    {t('general.intakeV2Enabled')}
                  </Label>
                  <p className="text-sm text-muted-foreground">
                    {t('general.intakeV2EnabledDescription')}
                  </p>
                </div>
                <Switch
                  id="intakeV2Enabled"
                  checked={settings.intakeV2Enabled ?? false}
                  onCheckedChange={(checked) => onSettingsChange({ ...settings, intakeV2Enabled: checked })}
                />
              </div>
            </div>
