              ...
              <div className="flex-1 min-w-0">
                ...
                {profile.models && Object.keys(profile.models).length > 0 && (
                  <div className="mt-2 text-xs text-muted-foreground">
                    {t('settings:apiProfiles.modelOverrides', {
                      models: Object.keys(profile.models).join(', ')
                    })}
                  </div>
                )}
                {profile.customModels && profile.customModels.length > 0 && (
                  <div className="mt-1 text-xs text-muted-foreground">
                    {t('settings:apiProfiles.customModelsSummary', {
                      models: profile.customModels
