...
import { ProjectModelRoutingSettings } from '../../project-settings/ModelRoutingSettings';
  ...
  switch (activeSection) {
    ...
    case 'model-routing':
      return (
        <SettingsSection
          title="Model Routing"
          description="Override which iFlow models run for this project"
        >
          <InitializationGuard
            initialized={!!project.autoBuildPath}
            title="Model Routing"
            description="Initialize this project to configure model routing overrides."
          >
            <ProjectModelRoutingSettings
              envConfig={envConfig}
              updateEnvConfig={updateEnvConfig}
            />
          </InitializationGuard>
    ...
    case 'plan-import':
      return (
        <SettingsSection
          title={t('projectSections.plan-import.title')}
          description={t('projectSections.plan-import.description')}
        >
          <InitializationGuard
            initialized={!!project.autoBuildPath}
            title={t('projectSections.plan-import.title')}
            description={t('projectSections.plan-import.description')}
          >
            <PlanImportSection projectId={project.id} />
          </InitializationGuard>
        </SettingsSection>
      );
