import type { Task, WorktreeStatus, WorktreeDiff, MergeConflict, MergeStats, GitConflictInfo, PostCodeTestsReport } from '../../../shared/types';
import {
    ...
    <div className="space-y-4">
      ...
      {isLoadingWorktree ? (
        ...
        <WorkspaceStatus
          ...
          onAllowMergeWithoutTestsChange={onAllowMergeWithoutTestsChange}
