...
export const IPC_CHANNELS = {
  ...
  TASK_CREATE_SANDBOX: 'task:createSandbox',
  TASK_IMPORT_PLAN: 'task:importPlan',
  TASK_IMPORT_PLAN_RESUME: 'task:importPlanResume',
  TASK_POST_CODE_TESTS_RUN: 'task:postCodeTestsRun',
  TASK_POST_CODE_TESTS_FIX: 'task:postCodeTestsFix',
  ...
  TASK_MODEL_ROUTING_GET: 'task:getModelRouting',
  TASK_MODEL_ROUTING_SET: 'task:setModelRouting',

  // Intake operations
  INTAKE_ANALYZE: 'intake:analyze',
  INTAKE_REANALYZE: 'intake:reanalyze',
  INTAKE_METRICS: 'intake:metrics',
  ...
  TASK_WORKTREE_APPLY_FIX: 'task:worktreeApplyFix',
  ...
  MODELS_GET_REGISTRY: 'models:getRegistry',
  ...
  // Auto-iFlow source environment configuration
  ...
  FILE_EXPLORER_OPEN: 'fileExplorer:open',
  ...
  // iFlow CLI operations
  IFLOW_CLI_CHECK: 'iflow:checkCli',
  IFLOW_CLI_AUTH: 'iflow:auth',
  IFLOW_CLI_RESET_OAUTH: 'iflow:resetOauth',
  ...
  // Consilium multi-agent orchestrator
  CONSILIUM_START: 'consilium:start',             // Start Consilium session with task
  CONSILIUM_STOP: 'consilium:stop',               // Stop running Consilium session
  CONSILIUM_APPROVE: 'consilium:approve',         // Approve the generated plan
  CONSILIUM_REJECT: 'consilium:reject',           // Reject plan and provide feedback
  CONSILIUM_GET_STATUS: 'consilium:getStatus',    // Get current session status

  // Consilium events (main -> renderer)
  CONSILIUM_OUTPUT: 'consilium:output',           // Streaming output from agent
  CONSILIUM_PLAN_READY: 'consilium:planReady',    // Plan is ready for review
  CONSILIUM_COMPLETE: 'consilium:complete',       // Task completed
  CONSILIUM_ERROR: 'consilium:error'              // Error occurred
} as const;
