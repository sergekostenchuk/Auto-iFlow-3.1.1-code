...
def temp_github_dir(tmp_path):
    ...
    github_dir = tmp_path / ".auto-iflow" / "github"
...
class TestBotDetectionE2E:
    ...
    def test_full_bot_detection_flow(self, tmp_path):
        ...
        with patch.object(BotDetector, "_get_bot_username", return_value="auto-iflow[bot]"):
        ...
        bot_pr = {"author": {"login": "auto-iflow[bot]"}}
        bot_commits = [{"author": {"login": "auto-iflow[bot]"}, "oid": "bot_commit"}]
