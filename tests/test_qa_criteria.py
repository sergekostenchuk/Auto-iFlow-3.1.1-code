...
# =============================================================================
# MOCK SETUP - Must happen before ANY imports from auto-iflow
# =============================================================================
...
# Now we can safely add the auto-iflow path and import
...
class TestSyncPlanStatusAfterQA:
    """Tests for sync_plan_status_after_qa function."""

    def test_sync_plan_status_blocks_when_tests_failed(
        ...
        plan = {
            ...
            "status": "ai_review",
            "planStatus": "review",
            "post_code_tests": {"status": "failed"},
        }
        save_implementation_plan(spec_dir, plan)

        result = sync_plan_status_after_qa(spec_dir)
        assert result is False

        updated = load_implementation_plan(spec_dir)
        assert updated["status"] == "ai_review"

    def test_sync_plan_status_allows_when_tests_passed(
        self, spec_dir: Path, qa_signoff_approved: dict
    ):
        plan = {
            "feature": "Test",
