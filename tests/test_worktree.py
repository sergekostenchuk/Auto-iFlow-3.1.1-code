...
from worktree import AUTO_BUILD_BRANCH_NAMESPACE, WorktreeManager
...
class TestWorktreeManagerInitialization:
    ...
    def test_init_with_valid_git_repo(self, temp_git_repo: Path):
        ...
        assert manager.worktrees_dir == temp_git_repo / ".auto-iflow" / "worktrees" / "tasks"
...
class TestWorktreeCreation:
    ...
    def test_create_worktree(self, temp_git_repo: Path):
        ...
        assert info.branch == f"{AUTO_BUILD_BRANCH_NAMESPACE}/test-spec"
    ...
    def test_create_worktree_with_spec_name(self, temp_git_repo: Path):
        ...
        assert info.branch == f"{AUTO_BUILD_BRANCH_NAMESPACE}/my-feature-spec"
